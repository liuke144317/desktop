...
<style scoped>
  ...
  .main-login-bg{width:100%; min-width:1000px; height:620px; background:url('../../../static/apps/TestLogin/zdrjypsm_login_bg.png') center center no-repeat;}
  ...
  #login_tab .div_pw span{position:absolute; left:15px; top:12px; width:16px; height:18px; background:url(../../../static/apps/TestLogin/iphone.png) 0 -480px no-repeat; z-index:1;}
  ...
  .warp_bg{height:200px;position:relative;background:url(../../../static/apps/TestLogin/wrap_bg.png) 0 0px no-repeat;padding-top:95px;}
  ...
  .silder-ctrl-prev, .silder-ctrl-next{;position: absolute;top: 50%;margin-top: -65px;width: 30px;height: 45px;cursor: pointer;background: url(../../../static/apps/TestLogin/icon_v9.png) no-repeat 5px 5px;}
  .silder-ctrl-prev{left:-30px;}
  .silder-ctrl-next{right:-30px;background-position: -5px -40px;}
  .silder-ctrl-con{display: inline-block;width: 32px;height: 20px;margin: 0 10px;cursor: pointer;text-indent: -100px;overflow: hidden;background: url(../../../static/apps/TestLogin/icon_v9.png) no-repeat -32px -112px;}
  .current{background: url(../../../static/apps/TestLogin/icon_v9.png) no-repeat 0px -92px ;}
